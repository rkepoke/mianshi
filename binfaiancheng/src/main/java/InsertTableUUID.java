...
public class InsertTableUUID {
    ...
    private void createTable() {
        ...
        try {
            ...
            String dropSql = "drop table if exists person_uuid_mf1932079;";
            stmt.executeUpdate(dropSql);
            sql = "CREATE TABLE person_uuid_mf1932079 (" +
    ...
    public void insertData() {
        ...
        // todo : modify the name, add your person_uuid id at the end, for example: person_uuid_171250001
        String sql = "insert into person_uuid_mf1932079 (uuid,name,age,gender) values (?,?,?,?)";
        try {
            conn = getConnection();
